...
//类型三
int DetectAnswer(Mat Img,vector<ItemPos> questionInfo,MarkersBoundaryTable &mbt,AnswerResult &ar,bool quetionType,double sensibilityThresh,double areaThreshold,int seSize=0);
//类型三多组
int DetectAnswer(Mat Img,vector<ItemPos> questionInfo,map<ushort,MarkersBoundaryTable*> &mbtMap,AnswerResult &ar,bool quetionType,double sensibilityThresh,double areaThreshold,int seSize=0);
//类型一
int DetectAnswer1(Mat Img,vector<ItemPos> questionInfo,MarkersBoundaryTable &mbt,AnswerResult &ar,double sensibilityThresh,double areaThreshold);
//类型二、三 每小题的答案识别
int DetectPreQuestionAnswer( Mat roi,bool isCrosswise,bool isSingleChoice,int optionNum,bool quetionType,double sensibilityThresh,double areaThreshold,int seSizeTh,PerquestionResult &result);
//类型一 每小题的答案识别
